...
adb push $OUT/system/lib/libc2d2_a3xx.so /system/lib
adb push $OUT/system/lib/libc2d2_z180.so /system/lib
adb push $OUT/system/lib/libOpenVG.so /system/lib/
adb push $OUT/system/lib/libsc-a2xx.so /system/lib/
adb push $OUT/system/lib/libsc-a3xx.so /system/lib/
adb push $OUT/system/lib/libllvm-a3xx.so /system/lib
...
adb push $OUT/system/etc/firmware/a300_pfp.fw  /system/etc/firmware
adb push $OUT/system/etc/firmware/a300_pm4.fw  /system/etc/firmware
#adb shell stop
#adb shell start
